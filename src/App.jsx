  ...
  return (
    <>
      ...
      <div className="relative overflow-x-clip">
        <div aria-hidden className="pointer-events-none absolute -top-40 left-1/2 h-[600px] w-[1200px] -translate-x-1/2 rounded-full opacity-30" 
        style={{ background: 'radial-gradient(600px 600px at 50% 50%, #2ee6ff55, transparent 60%), radial-gradient(600px 600px at 60% 40%, #6a5cff55, transparent 60%)'}} />
